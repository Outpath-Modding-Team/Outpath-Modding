...
//        public static ResourcePrefab MainResourcePrefab { get; private set; } = MainResourcePrefab ??= new ResourcePrefab(IslandParentGenerators.IslandGenerators[BiomeType.Grasslands].isleGenerators[0].blocks.First(x => x.name.Contains("Stone")).GetComponent<Block>().propToSpawn.First(x => x.itemPrefab.name.Contains("Prop_Rock")).itemPrefab.GetComponent<TakeOutResource>());
...
//        //public ResourcePrefab CreatePrefab()
//        //{
//        //    ResourcePrefab prefab = MainResourcePrefab.CopyProperties();
//        //}
